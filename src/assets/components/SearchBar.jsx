  ...
  return (
    <div className="relative group w-full max-w-2xl">
      ...
      <input
        ...
        className="w-full py-1.5 pl-12 pr-12 text-white bg-zinc-900/40 border border-white/10 rounded-full outline-none backdrop-blur-md transition-all duration-300 placeholder:text-zinc-500 hover:bg-zinc-900/60 hover:border-white/20 focus:bg-zinc-900/80 focus:border-white/40 focus:shadow-[0_0_20px_rgba(255,255,255,0.05)]"
      />
